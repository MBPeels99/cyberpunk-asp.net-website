...
namespace Night_City.Pages
{
    public partial class AddDistrict : System.Web.UI.Page
    {
        ...
        protected void btnAddDistrict_Click(object sender, EventArgs e)
        {
            ...
            string imageMap = SaveFile(fuImageMap, districtName, "Image_Map");
            string backImage = SaveFile(fuBackImage, districtName, "Back_Image");
            string imageOne = SaveFile(fuImageOne, districtName, "Image_One");
            string imageTwo = SaveFile(fuImageTwo, districtName, "Image_Two");
